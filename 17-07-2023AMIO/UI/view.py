...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        #ROW 1
        self._ddYear1 = ft.Dropdown(label="Year ", width=150)
        self._ddBrand = ft.Dropdown(label="Brand", width=150)
        ...
        row1 = ft.Row([self._ddYear1, self._ddBrand, self._btnBuildGraph, self._btnPrintDetails],
        ...
        self._ddProdotto = ft.Dropdown(label="Prodotto", width=150)

        self._btnCalcolaSoluzione = ft.ElevatedButton(text="Cerca percorso", on_click=self._controller.handleCercaTeamSfortunati)

        row3 = ft.Row([self._ddProdotto,  self._btnCalcolaSoluzione],
                      alignment=ft.MainAxisAlignment.CENTER)
